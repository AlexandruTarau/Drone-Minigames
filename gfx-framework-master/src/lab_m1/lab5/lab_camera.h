    ...
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::vec4 newRight = glm::rotate(glm::mat4(1.0f), angle, right) * glm::vec4(right, 1);
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::vec4 newForward = glm::rotate(glm::mat4(1.0f), angle, up) * glm::vec4(forward, 1);
            glm::vec4 newRight = glm::rotate(glm::mat4(1.0f), angle, up) * glm::vec4(right, 1);
            forward = glm::normalize(glm::vec3(newForward));
            right = glm::normalize(glm::vec3(newRight));
            up = glm::cross(right, forward);
        }
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::vec4 newForward = glm::rotate(glm::mat4(1.0f), angle, forward) * glm::vec4(forward, 1);
